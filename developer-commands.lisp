...
(clim:define-command
    (com-reset-profile :name t :command-table climacs1-gui:development-table)
    ()
  #+sbcl (sb-profile:reset)
  #-sbcl nil)

(clim:define-command
    (com-report-profile :name t :command-table climacs1-gui:development-table)
    ()
  #+sbcl (sb-profile:report)
  #-sbcl nil)

(clim:define-command
    (com-recompile :name t :command-table climacs1-gui:development-table)
    ()
